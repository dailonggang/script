...
if __name__ == '__main__':
    ...
    xml_dir = '../VOCdevkit/VOC2007/Annotations'  # 已知的voc的标注
    ...
    for xml_file in xml_list:
        ...
        shutil.copy(os.path.join('../VOCdevkit/VOC2007/JPEGImages', img_name),
                    os.path.join('./coco/val2017', img_name))
    # train data
    ...
    for xml_file in xml_list:
        img_name = xml_file[:-4] + '.jpg'
        shutil.copy(os.path.join('../VOCdevkit/VOC2007/JPEGImages', img_name),
                    os.path.join('./coco/train2017', img_name))
